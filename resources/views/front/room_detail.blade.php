        ...
        <div class="row">
            <div class="col-lg-8 col-md-7 col-sm-12 left">
                ...
                <div class="room-detail-carousel owl-carousel">
                    <div class="item" style="background-image:url({{ asset('uploads/featured_photo/'.$single_room_data->featured_photo) }});">
                        <div class="bg"></div>
                    </div>

                    @foreach($single_room_data->rRoomPhoto as $item)
                    <div class="item" style="background-image:url({{ asset('uploads/roomgallery/'.$item->photo) }});">
                        <div class="bg"></div>
                    </div>
                    @endforeach
