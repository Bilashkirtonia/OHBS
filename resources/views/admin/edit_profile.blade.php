            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin_profile_submit') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <img id="show_image" src="{{ asset('uploads/profile/'.Auth::guard('admin')->user()->photo) }}" alt="" class="profile-photo w_100_p">




                                <input type="file" class="form-control mt_10"   accept="image/*" name="photo" id="file"  onchange="loadFile(event)" >
