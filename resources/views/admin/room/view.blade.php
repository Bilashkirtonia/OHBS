...
<a href="{{ route('admin.room.add') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add New</a>
@endsection
                        ...
                        <table class="table table-bordered" id="example1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ asset('uploads/featured_photo/'.$row->featured_photo) }}" alt="" class="w_100">
                                    </td>
                                    <td>{{ $row->name }}</td>
                                    <td>${{ $row->price }}</td>
                                    <td class="pt_10 pb_10">
                                        ...
                                        <a href="{{ route('admin.room.delete',$row->id) }}" class="btn btn-danger" onClick="return confirm('Are you sure?');">Delete</a>
                                    </td>
                                </tr>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group row bdb1 pt_10 mb_0">
                                                    ...
                                                    <div class="col-md-8">
                                                        <img src="{{ asset('uploads/featured_photo/'.$row->featured_photo) }}" alt="" class="w_200">
                                                    </div>
                                                </div>
                                                <div class="form-group row bdb1 pt_10 mb_0">
                                                ...
                                                <div class="form-group row bdb1 pt_10 mb_0">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="iframe-container1">
                                                            <iframe width="460" height="315" src="https://www.youtube.com/embed/{{ $row->video_id }}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
